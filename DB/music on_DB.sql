...
INSERT INTO music (music_name, music_genre, music_style, music_team, music_year) VALUES 
(
'아주 NICE', -- music name
'댄스', -- music genre
'신나는 노래', -- music style (잔잔한 노래 / 신나는 노래 / 열정적인 노래 / 슬픈 노래 / 힘이 나는 노래 / 암울한 노래)
'남성', -- music gender (남성 / 여성 / 혼성)
'보이그룹', -- music team (솔로 / 아이돌 / 그룹 / 밴드 / 인디)
'2016' -- music year
);
ALTER TABLE music ADD music_year YEAR;
-- 전체 DB표 확인
SELECT * FROM music;
...
-- CHECK MUSIC_TEAM. 팀 확인 // (솔로 / 아이돌 / 그룹 / 밴드 / 인디)
SELECT * FROM music WHERE music_team = '밴드';

-- CHECK MUSIC_YEAR. 년도 확인 // 
